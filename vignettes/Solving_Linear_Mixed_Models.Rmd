...
In the following mixed model we include rep and gen as fixed effect, and `spl1D` to model a one dimensional P-spline [@Eilers1996] with 200 segments, and using the default choice of cubical B-splines and second order differences:
...
with the first genotype (G01) is the reference, as genotypes were modelled as fixed effect in the model.
